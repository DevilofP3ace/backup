...
public class RY : MonoBehaviour {
    int counterposition;
    float colorcheck;// this one is so if function isnt called when not needed
    bool coloreff;
	...
	void Update () {
        ...
        if (counterposition != 0)
        {
            ...
            //rend.material.SetColor("_Color", Color.yellow);
            transform.localPosition += Vector3.up*0.15f*counterposition;
            counterposition = 0;
